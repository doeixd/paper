...
Propositions earn Level 2 or Level 1 status through a journey from hypothesis to hard core. A proposition starts as a tentative claim, tested for coherence and cost-reduction. Success promotes it to Standing Predicate, then to core principle if it unifies domains and minimizes brittleness. This process grounds deflationary truth theories: truth is not correspondence but alignment with emergent viable structures, providing substantive grounding for linguistic deflationism.
