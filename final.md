...
Coherentist theories of justification face the isolation objection: a perfectly coherent belief system could be detached from reality. Standard responses, including Quinean naturalism, incorporate external constraints through empirical experience, but they lack a forward looking diagnostic for assessing epistemic health before systemic failure occurs.

This paper develops Emergent Pragmatic Coherentism (EPC) to address this gap. This naturalistic externalist framework grounds coherence in the long-term viability of public knowledge systems. EPC introduces systemic brittleness as the missing diagnostic tool. It assesses epistemic health by tracking the observable costs generated when a system’s propositions are applied. Selective pressure from these costs drives disparate knowledge systems to converge on an emergent, objective structure we term the Apex Network. This is not a pre-existing truth but the constraint-determined set of maximally viable solutions forged by historical failure filtering.
