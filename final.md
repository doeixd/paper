...
Coherentist theories of justification face the isolation objection: a belief system could be perfectly coherent yet entirely detached from reality. This paper resolves this challenge through Emergent Pragmatic Coherentism (EPC), which grounds coherence in demonstrated viability measured by systemic brittleness. EPC synthesizes constraint network theory (Thagard 1989), network epistemology (Zollman 2007), Rescher's systematicity, and Kitcher's evolutionary dynamics, adding external brittleness diagnostics these internalist precursors lacked. The framework inherits Quine's holistic, pragmatically-revised web architecture as essential infrastructure: systemic brittleness, pragmatic pushback, and convergence all require this structure, though the systems-level analysis remains neutral on specific metaphysics of belief.

The framework uses systemic brittleness as a diagnostic tool, measuring network health through observable costs incurred when applying propositions. Selective pressure from these costs drives knowledge systems toward convergence on an emergent structure: the Apex Network, comprising maximally viable propositions. Justification requires both internal coherence and a network's demonstrated resilience. Objective truth is redefined as alignment with the Apex Network, not as a metaphysical blueprint but rather as the necessary structure of optimal solutions determined by mind-independent pragmatic constraints. The framework explains pragmatic revision in Quine's web of belief, provides prospective guidance through constraint analysis, and supports a falsifiable research program for assessing epistemic health. Preliminary applications to historical cases, such as the transition from Ptolemaic to Copernican astronomy, and to contemporary challenges in AI development, illustrate the framework's diagnostic potential.
...
The Quinean inheritance is architectural, not merely methodological. Our framework requires knowledge to be structured as holistic webs subject to pragmatic revision, with individual webs coordinating into public knowledge systems converging toward constraint-determined objectivity. This architecture is non-negotiable: systemic brittleness makes sense only for interconnected networks where adjustments ripple through the system; pragmatic pushback requires revision mechanisms that modify structure; convergence requires overlapping webs that can align toward an objective standard. Without these structural features, the framework collapses. Quine's account provides this architecture in thoroughly naturalized form. Alternative foundations preserving these features (holism, pragmatic revision, coordination, constraint-determined objectivity) remain compatible with our systems-level analysis, though the specific dispositional semantics remains optional.
...
The path from individual disposition to public knowledge proceeds in stages, with conscious awareness serving as the bridge from private behavior to coordinated public claims.
...
The architectural requirements outlined above are not arbitrary methodological choices but structural prerequisites for the framework's core mechanisms. Each feature proves essential for distinct reasons.

Holism matters for systemic brittleness. Brittleness accumulates through cascading costs across interconnected networks. Atomistic beliefs cannot exhibit systemic brittleness in the relevant sense. A false atomic belief is simply false, full stop. Only in holistic webs do adjustments create ripple effects, generating the conceptual debt (P(t)) and complexity inflation (M(t)) our diagnostics track. When phlogiston theory faced anomalies, the problem was not isolated errors but cascading modifications required to preserve the core. This systemic character of failure requires holistic structure.

Pragmatic revision matters for causal efficacy. External costs must causally modify knowledge structures. Without revision mechanisms, pragmatic pushback becomes inert. Systems could acknowledge costs without adjusting, like a thermostat that reads temperature but never triggers the furnace. The Quinean architecture ensures costs drive actual restructuring rather than mere recognition. When germ theory succeeded, it was not because people acknowledged miasma theory's costs while keeping it, but because those costs forced structural revision.

Social coordination matters for convergence. The Apex Network emerges through coordination of individual webs under shared pragmatic constraints. Atomistic beliefs cannot coordinate in the required sense; they can only aggregate statistically. The overlapping web structure enables the emergent convergence our framework predicts. When medical researchers worldwide independently converged on germ theory principles, this was not mere coincidence but structural necessity: shared constraints forced alignment of individual webs.

Constraint-determined objectivity matters for realism. The framework's response to the isolation objection requires that reality impose an objective structure. Without this, coherent systems could float free indefinitely. The Apex Network must exist as an objective feature of the constraint landscape, discovered through elimination rather than created by consensus. This is what distinguishes viable knowledge from coherent fiction: alignment with constraint-determined structure rather than internal consistency alone.

These features work together. Holism without revision yields static, brittle structures. Revision without coordination yields isolated individual adjustments with no cumulative progress. Coordination without objective constraints yields mere consensus, vulnerable to the isolation objection. The architecture must be package-complete.

Alternative foundations preserving these architectural features remain compatible with our analysis. What matters is the structure, not the specific metaphysical story undergirding it. However, any adequate foundation must explain how knowledge systems can be holistic, revisable, coordinative, and constrained by mind-independent reality. This is a demanding set of requirements, which explains why the Quinean apparatus proves so useful.

### 2.2 The Units of Analysis: Predicates, Networks, and Replicators

Having established that knowledge must be structured as holistic, pragmatically-revised, overlapping networks converging toward constraint-determined objectivity (the architectural requirements) and sketched one naturalistic foundation for this structure (Quinean dispositions), we now shift to the systems level where the framework's distinctive contributions emerge. Our deflationary move redirects attention from individual agent psychology to public, functional structures: the units of analysis that follow depend on the required architecture but not on any particular metaphysics of belief. These units (Standing Predicates, Shared Networks, and their evolutionary dynamics) presuppose holistic structure, pragmatic revision, and social coordination, but remain neutral on how individual minds ground these public systems. The alignment of individual webs into public knowledge occurs through convergence of behavioral patterns shaped by sustained pragmatic feedback, as detailed in Section 2.1.
...
### 4.3.2 Why Quine's Architecture Matters: Animating the Web

**Animating Quine's Web: From Static Structure to Dynamic Process**

Quine's "Web of Belief" (Quine 1951, 1960) provides the essential architecture for our framework: holistic structure, pragmatic revision, and overlapping coordination. However, Quine's account has been criticized for lacking dynamic mechanisms explaining web formation and change. This section shows how our brittleness diagnostics and entrenchment mechanisms complete Quine's architecture, providing the missing causal story. This demonstrates why the Quinean architecture is not merely compatible with our framework but essential to it: without holistic structure, brittleness cannot accumulate systemically; without pragmatic revision, costs cannot drive adaptation; without overlapping webs, convergence toward the constraint-determined Apex Network cannot occur. Our framework provides the missing mechanisms.
