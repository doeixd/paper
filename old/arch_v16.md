...
A system’s *brittleness* is a measure of its accumulated systemic costs. To make this concept analytically tractable, it can be operationalized by tracking concrete, measurable indicators. The following table provides a conceptual illustration of how one might construct such a diagnostic toolkit. It is crucial to emphasize that this is not a final algorithm but a heuristic guide. We acknowledge the significant challenge of operationalizing these proxies in non-question-begging ways. The purpose of this framework is to ground a research program aimed at identifying trajectories of rising systemic risk, not to offer deterministic predictions.
...
| \*\*Increasing Model Complexity\*\* | Computational Systems (e.g., Deep Learning) | Escalation in computational resources (e.g., FLOPs) required for marginal performance gains; a rising ratio of publications on auxiliary modifications versus foundational advances. | arXiv trends, AI conference proceedings |
...
The historical process of filtering out high-brittleness systems is not merely destructive. As unviable designs are relegated to the Negative Canon, this pragmatic selection constructively reveals the contours of an objective structure that all successful inquiry is forced to approximate. This emergent structure is what we term the **Apex Network**. To be precise about its status, it is not a pre-existing metaphysical blueprint awaiting discovery, nor the territory of reality itself, nor is it merely our current consensus. The Apex Network is the name for the theoretical limit-point of this process of convergence, a concept that shares a deep affinity with the classical pragmatist notion of truth as the ideal end of inquiry (Peirce 1878). Our Consensus Network is a fallible, historically-situated attempt to chart the structure; the Apex Network is the objective structure being charted.

Rather, the Apex Network has a distinct, naturalized ontological status: it is an emergent structural fact about the landscape of pragmatic constraints. It is not a metaphysical blueprint awaiting discovery, but an objective pattern formed by the historical filtering of unviable systems. To clarify this concept, consider an analogy. While an individual's color preference seems entirely subjective, a non-random pattern emerges at the macro-level of cross-cultural data: a striking convergence on the color blue. This is an objective, emergent fact demanding a naturalistic explanation, which lies in the evolutionary selection pressures of our shared terrestrial environment. The objective fact is not a metaphysical rule stating "Thou shalt favor blue," but the emergent, structural relationship: for a species like ours, under these constraints, a preference for blue is a highly viable, low-cost perceptual default. The Apex Network has the same ontological status. It is the singular, maximally coherent system of predicates and their relations, forged from the bottom up by the convergence of countless problem-solving efforts under pragmatic pressure. This network represents the set of maximally viable, low-cost solutions to the problems posed by our world, and as such, it constitutes the real, mind-independent structure of viability that disciplines all successful inquiry.

The mechanism that forges this structure is a purely **bottom-up emergence**, not a top-down design. Local Shared Networks, developed to solve specific problems, are forced to cohere with one another because they operate in an interconnected world. This pressure for cross-domain consistency generates a strong tendency toward a single, maximally shared and integrated network, as maintaining incoherence between successful systems incurs unsustainable systemic costs. The Apex Network is the name for the theoretical limit-point of this process of convergence: the singular, maximally coherent system whose structure is determined by the full set of mind-independent pragmatic constraints.

The Apex Network's function as a standard for objective truth follows from this status as a singular, maximally coherent system. The dynamic can be understood through Susan Haack's (1993) crossword puzzle analogy. A proposition is not objectively true because it corresponds to an isolated fact, but because it is an indispensable component of the unique, fully completed, and maximally coherent solution to the entire puzzle—a solution disciplined by thousands of external "clues" in the form of pragmatic pushback. A proposition's truth is thus secured by its necessary and irreplaceable role in the overall structure of the most viable system of knowledge. The "pursuit of truth," then, is the practical, fallible project of refining our current Consensus Network to better align with this real, objective structure.
...
To provide the naturalistic grounding for the analogy of color preference introduced in Section 4.2, let us examine the details of this case. Cross-cultural patterns in color perception, a domain that initially appears subjective, offer a concrete model for how objective structural constraints emerge from the aggregation of fallible individual practices, thereby illustrating the broader mechanism of epistemic convergence.

Recall the central observation: while individual tastes are contingent, a non-random pattern emerges at the macro-level, with a striking cross-cultural convergence on the color blue. This convergence is not an accident but an emergent structural fact that demands the kind of naturalistic explanation our model provides. It serves as a miniature of the process by which an Apex Network precipitates out of countless individual, contingent systems.
...
### **4.6 Illustrative Cases of Convergence and Brittleness**
...
A system can become locked into a high-brittleness **fitness trap** due to coercive institutions or other contingent historical factors. A slave economy, for instance, is a classic fitness trap: it is objectively brittle in the long run, but as Acemoglu and Robinson (2012) have extensively documented, it creates path-dependent institutions that make escaping the trap even costlier in the short term. The raw power of the ruling class does not negate the system's brittleness; instead, the resources spent on maintaining that power (the **coercive overheads**) become a primary *indicator* of that brittleness. The persistence of such a system is not a sign of its viability, but a measure of the energy it must expend to resist the structural pressures pushing it toward collapse.
...
Finally, we must distinguish this high-brittleness fitness trap from a different state: low-brittleness stagnation. A system can achieve a locally stable, low-cost equilibrium that is highly resilient to existing shocks but lacks the mechanisms for generating novel solutions to new problems. A traditional craft that has perfected its techniques for a stable environment but cannot adapt to a new material, or a scientific paradigm that is efficient at solving puzzles within its domain but resists revolutionary change, would be examples. While not actively accumulating systemic costs, such a system is vulnerable to a different kind of failure: obsolescence in the face of a novel, fast-adapting competitor. Diagnosing this condition requires not just a snapshot of the current brittleness score, but an analysis of the rate of adaptive innovation. This reveals that true, long-term viability requires a balance between low-cost stability and adaptive capacity.
...
First, the concept of "cost" is defined through an objective, tiered diagnostic framework. At the most fundamental level are the least-contestable *bio-social costs*, such as excess mortality or resource depletion. A second level concerns the *systemic costs of internal friction*, such as the resources a system must expend on coercion rather than production. This framework also allows us to diagnose cost-shifting, a process where a system appears efficient by deferring costs onto a social or ecological substrate, as a primary indicator of hidden, long-term brittleness.

Second, the model explains how abstract principles exert real force on inquiry through the concept of *noncausal epistemic powers*, a notion analogous to the "noncausal powers" developed in contemporary metaethics (Baysan 2025). The property of being a justified truth does not physically cause scientists to act, but it confers on a proposition the power to justify further inferences or require the rejection of competing claims. The high systemic costs of a brittle network can thus be understood as the friction generated by a system attempting to operate in defiance of these objective principles.

Finally, the framework accounts for its own epistemic status by presenting itself not as an *a priori* truth but as a falsifiable research program. Its ultimate justification lies not in philosophical assertion but in its potential to generate a more productive, empirically grounded understanding of knowledge, as detailed below.

### **7.5 From Theory to Practice: A Falsifiable Research Program**

The claims of this framework are designed to ground concrete, empirically testable hypotheses. Its core causal claim is a falsifiable prediction: *a network with a high or rising degree of measured brittleness carries a statistically higher probability of collapse or major revision when faced with a comparable external shock.*

Testing this claim requires three methodological steps. First is the operationalization of brittleness indicators through quantifiable proxies for systemic cost, such as the ratio of state budgets for internal security versus R\&D or the rate of non-generative auxiliary hypotheses in scientific literature.

Second is comparative historical analysis. Using large-scale databases like the Seshat Databank, one could test the core hypothesis retrospectively. For instance, one could analyze multiple polities that faced similar shocks to determine if those with demonstrably higher pre-existing coercion ratios were statistically more likely to suffer collapse.

The theory is therefore rigorously falsifiable. If broad, methodologically sound historical analysis revealed no statistically significant correlation between indicators of high systemic cost and long-term network fragility, the framework's core causal engine would be severely undermined. This falsifiability criterion ensures the model meets the empirical standards it advocates for knowledge systems generally. We acknowledge that such a research program faces significant methodological challenges, including the operationalization of proxies, the control of confounding variables, and the interpretation of sparse historical data. The claim is not that this provides a simple algorithm for historical analysis, but that it offers a conceptually coherent and empirically grounded framework for it.
