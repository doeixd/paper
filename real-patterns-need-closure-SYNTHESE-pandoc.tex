...
\section{Real Patterns Need Closure: Transition Autonomy as a Dynamical
Criterion for
Macro-Objecthood}\label{real-patterns-need-closure-transition-autonomy-as-a-dynamical-criterion-for-macro-objecthood}

\subsection{Abstract}\label{abstract}

Dennett's real-pattern realism links ontology to compression and
prediction, but compression alone is too permissive: contrived codings
and dynamically idle aggregates can satisfy it. This paper argues that
the missing ingredient is an explicit closure condition. A candidate
macro-object qualifies when, for a fixed regime, horizon, and admissible
intervention class, macrostate information is sufficient for
macro-transitions, so within-class micro-differences do not change
macro-level what-follows. In exact Markov settings, strong lumpability
provides a benchmark realization of this condition. In non-ideal
settings, closure is graded through leakiness and convergent diagnostics
under fixed constraints. The result is realist but disciplined: it
excludes high-leak composites, supports graded verdicts in borderline
cases, and remains compatible with microphysical completeness. By tying
commitment strength to robustness under anti-gerrymandering tests, the
framework explains why selective realism is principled rather than
discretionary. The paper contributes a philosophical criterion and an
audit protocol for applying it, while leaving domain-specific estimator
engineering to downstream methodological work.

\textbf{Keywords:} real patterns, closure, macro-objecthood, strong
lumpability, coarse-graining, pattern realism

\subsection{1. Introduction: Why Pattern Realism Needs a Stricter
...
\subsubsection{1.1 Novelty and
Positioning}\label{novelty-and-positioning}
...
(Gładziejewski, 2025). That work helps explain why agents converge on
...
\subsubsection{1.2 Scope and Non-Claims}\label{scope-and-non-claims}
...
\subsubsection{1.3 Three Nearby Positions}\label{three-nearby-positions}
...
\subsubsection{1.4 Contribution Map}\label{contribution-map}
...
\subsection{2. Closure and
Admissibility}\label{closure-and-admissibility}

\subsubsection{2.1 Criterion in Plain
...
\subsubsection{2.2 Formal Statement}\label{formal-statement}
...
\subsubsection{2.3 Why This is More Than
...
\subsubsection{2.4 Admissibility and Hierarchical
...
\subsubsection{2.5 Pattern Reality Versus
...
\subsubsection{2.6 Admissibility Disputes}\label{admissibility-disputes}
...
\subsubsection{2.7 Canonical Criterion
...
\subsubsection{2.8 Predictive and Interventional
...
\subsubsection{2.9 Why Closure Carries Ontological
...
\subsubsection{2.10 Levels of Claim and
...
\subsubsection{2.11 Closure, Underdetermination, and Objecthood
...
\subsection{3. Exact Benchmark: Strong
...
\subsubsection{3.1 Minimal Formal
...
\subsubsection{3.2 If an Unusual Partition
...
\subsubsection{3.3 What the Formal Machinery Alone Does Not
...
\subsection{4. Approximate Closure Without Instrumentalist
Drift}\label{approximate-closure-without-instrumentalist-drift}

\subsubsection{4.1 Why Approximation is
...
\subsubsection{4.2 Leakiness as Canonical
...
\subsubsection{4.3 Procedural Safeguards in Non-Ideal
...
\subsubsection{4.4 Regime Dependence and
...
\subsubsection{4.5 One Distributed
...
\subsubsection{4.6 Failure Conditions and Downgrade
...
\subsubsection{4.7 Stable Versus Merely Entailed
...
\subsubsection{4.8 Practical Qualification Under Sparse Intervention
...
\subsubsection{4.9 Conceptual Contrast: Near-Tie Prediction, Different
Ontology
...
\subsubsection{4.10 Reporting and Evidential
...
\subsection{5. Objections and Replies}\label{objections-and-replies}
...
\subsubsection{5.1 ``Instrumentalism and
...
\subsubsection{5.2 ``Causal Exclusion Still Defeats Macro
...
\subsubsection{5.3 ``Autonomy, Pluralism, and
...
\subsubsection{5.4 ``The Markov Template is Too
...
\subsubsection{5.5 ``Formal Closure Collapses the View into
...
\subsubsection{5.6 ``Closure Is Too Strong and Eliminates Most Special
...
\subsubsection{5.7 ``Predictive Success and Failure
...
\subsubsection{5.8 ``Horizon-Relativity Makes the Criterion Too
...
\subsubsection{5.9 ``The Criterion Is Too
...
\subsection{6. Conclusion: A Disciplined Realism
...
Gładziejewski, P. (2025). Real patterns, the predictive mind, and the
cognitive construction of the manifest image. \emph{Synthese, 206}, 225.
https://doi.org/10.1007/s11229-025-05311-0

Haugeland, J. (1998). \emph{Having thought}. Harvard University Press.
...
Woodward, J. (2003). \emph{Making things happen}. Oxford University
Press.
