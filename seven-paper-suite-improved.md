# THE VIABILITY FRAMEWORK: A Seven-Paper Research Program
...
└──────────────────────────────┬─────────────────────────────────┘
                               ...
                               ▼
┌────────────────────────────────────────────────────────────────┐
│  ONTOLOGY: Invariantism (Paper 1)                              │
│  Viable structures = computational closure; invariances = truth│
└──────────────────────────────┬─────────────────────────────────┘
                               │
                               ▼
┌────────────────────────────────────────────────────────────────┐
...
## Title: *Invariantism: Toward a Non-Platonic Realism About Necessity*
...
| Concept | Paper 1 | Paper 2 | Paper 3 | Paper 4 | Paper 5 | Paper 6 | Paper 7 |
|---------|---------|---------|---------|---------|---------|---------|---------|
| Invariance | Central thesis | = Structural regularity | Object of consciousness | — | What predicates track | What math discovers | Coordination constraints |
| Computational Closure | Viability criterion | Standing Predicate formation | Agent as closed system | Generative model | Apex Network | Logic as precondition | Agents vs. objects |
| Markov Blanket | Structure mechanism | Crystallized phantasm | Self as control variable | Web of belief | Knowledge system boundary | — | Social systems |
| Brittleness | Closure failure | Rigid complex | — | High free energy | Central diagnostic | Proof complexity | Coercion costs |
| Attractor | Apex Network | — | — | Equilibrium belief state | Truth as attractor | Mathematical convergence | Viable coordination |
...
**The Mechanism:**
Markov blankets create levels of description. When a level achieves closure (dynamics self-contained), it's viable. Invariances at viable levels are objective—not constructed, discovered. Different inquirers navigating the same viability landscape converge on the same attractors.
