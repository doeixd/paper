...
This paper argues that screening off is necessary but not sufficient.
...
secured. The reporting schema is therefore how a lattice-shaped ontology
is made explicit. Rosas et al. provide the formal architecture for
nested closure structure; the present paper's contribution is to turn
that architecture into an ontological reporting discipline
\citep{rosas2024}.

Those verdicts also have practical consequences for philosophical
practice. Robust verdicts support unqualified realist commitment within
the declared regime and explanatory reliance without special caveats.
Qualified verdicts support selective commitment only with explicit
regime, horizon, or admissibility limitations, and they should prompt
active comparison with nearby candidate partitions. Indeterminate
verdicts do not support settled ontology claims at all. They call for
suspension, partition revision, or further evidential work.
...
macro-what-follows, that is, for the relevant macro-transition profile
under the declared constraints? In practice, three checks are usually
enough.
...
incomplete. This paper argues for a staged protocol. Compression
identifies candidate patterns. Screening off plus novelty, in Franklin
