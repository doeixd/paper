...
\citep{millhouseetal2026,ladyman2026}.
...
the upstream driver, and conditioning on the proxy can render a wide
range of lower-level detail irrelevant to the target macro-outcome. In
that limited but important sense, the case can look as though the
screening-off requirement has been met. The paper's claim is that this
still leaves open whether the proxy itself carries autonomous transition
structure.
