...
\(A_t = U^1_t\) and \(B_t = U^2_t\), and \(Z_t = U^1_t \oplus U^2_t\). The restriction of the observed process
to the synchronized manifold is therefore a fact about which channels
...
established that higher-level kinds
