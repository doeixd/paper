...
Levels on this view are discovered features of system dynamics; they
relate by nesting when closed grains stand in refinement relations; and
the micro-level carries no privilege from being smallest, since what
...
\begin{enumerate}
	...
	\item
	      ...
	      admissible class \(I\). The supremum is what makes the quantity a
	      test of the candidate: under an average, a partition could earn
	      robust standing by being homogeneous on some convenient
