...
\begin{enumerate}
	...
	\item
	      ...
	      intervention. This is the criterion's quantity, and its domain
	      has to be stated, since the verdict turns on it. For each
	      macrostate \(z\), let \(R_I(z)\) be the microstates \(x\) with
	      \(g(x) = z\) that are reachable by interventions in the
	      ...
	      quantity is a supremum over them and over macrostates:
	      \[
		      \Lambda_I(Z) \;=\; \sup_{z} \;\;
		      \sup_{\mu \in \mathcal{M}_I(z)}
		      I_\mu\!\left(X_t; Z_{t+1}\right),
	      \]
	      where conditioning on \(Z_t\) drops out because \(\mu\) is
	      already confined to one macroclass. The supremum is what makes
	      the quantity a test of the candidate: under an average, a
