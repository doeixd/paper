...
qualified verdict reports a real but fragile place in that structure.
An indeterminate verdict reports that no stable placement has yet been
...
machinery into an ontological criterion with explicit verdict and
downgrade structure \citep{rosas2024}. Relative to Ladyman and
...
concepts. If rejected, it should be rejected because one rejects its
stated commitments, not because circularity, instrumentalist drift, or
scope ambiguity were left unresolved.
