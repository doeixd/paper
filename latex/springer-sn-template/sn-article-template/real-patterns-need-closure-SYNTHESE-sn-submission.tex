...
is that the present criterion can diverge from purely observational
...
Several neighboring traditions are engaged where they become dialectically
active. Simon and Wimsatt on near-decomposability
...
pattern realism \citep{millhouse2022,wallace2024,jiang2024,jiang2025,millhouseetal2026,ladyman2026}
are each addressed at the points where their specific contributions
bear on the argument. The present paper's narrower claim is that even
the strongest of these views leaves open a final admittance question
that closure is proposed to answer.
...
To be clear: the paper does not require interventions as metaphysical
glue. It requires intervention-invariance as evidence that a candidate
partition is tracking stable organization across physically real,
regime-preserving perturbations to boundary conditions, couplings, or
control channels. That is a methodological route to structural
stability, not a retreat to fundamental causal ontology.
...
That distinction clarifies dialectical burden: the paper need only show
...
philosophical: this ordered space gives the best interpretation of disciplined
...
observation is compatible with the present account: universality classes
...
focus is explanatory structure; the present criterion adds an objecthood
...
The structured-space payoff can be stated directly. Once
...
what the rainforest becomes under a closure discipline: the structured
...
The present paper relies on Franklin and Robertson's program. Their
criterion removes obvious gerrymanders and clarifies the importance of
law-like macrodependence. The present claim is that one further filter
...
The view accordingly separates itself from eliminativist pressure by
neither treating higher-level descriptions as fictions by default nor
granting them standing by convenience alone, but asking whether they
track stable transition structure under admissible intervention. If they do, that supports realist commitment on the
