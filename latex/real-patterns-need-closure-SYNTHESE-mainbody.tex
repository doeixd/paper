...
transition structure under admissible perturbation.
...
its trajectories synchronized. In that respect, the screening-off result
is not illusory. But the variable remains parasitic on the shared
source. If an admissible intervention perturbs the proxy while leaving
the driver intact, the apparent autonomy disappears. The macro-variable
did not carry autonomous transition organization after all. Closure
therefore sorts one class of survivors that screening off alone does not
yet exclude.
