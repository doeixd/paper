...
Consider a composite variable that aggregates two subsystems both
driven by a shared upstream oscillator. Under passive observation, the
composite's macro-state predicts its own future as well as the full
micro-state does, because the shared driver synchronizes the subsystems
and makes their joint trajectory compressible. An
