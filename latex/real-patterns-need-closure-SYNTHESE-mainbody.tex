...
target extends beyond the memorized cases (Dennett, 1991, pp. 32--33).
...
(Haugeland, 1998), and versions of the ``cheap coding'' objection recur
throughout the subsequent literature (Elgin, 2017). The present paper
...
physical feasibility (Pearl, 2000). For causal inference, that
...
(Pearl, 2000). Closure is related to this property but not identical to
...
realism (Ainsworth, 2009). Extensional structure alone can be cheap under recoding.
...
transition probabilities to all macroclasses (Kemeny \& Snell, 1960). When this condition holds,
...
require perfect closure everywhere. The mathematical study of approximate aggregation has a long history, particularly in the analysis of nearly decomposable systems (Ando \& Simon, 1961). The present extension is philosophical rather than technical: it uses graded closure to support graded ontological verdicts, not to improve estimation.
...
quantity is \(I(X_t; Z_{t+1} \mid Z_t)\) (Cover \& Thomas, 2006). Low values support closure.
...
Ainsworth, P. M. (2009). Newman's objection. \emph{The British Journal
	for the Philosophy of Science, 60}(1), 135--171.
https://doi.org/10.1093/bjps/axn051

Ando, A., \& Simon, H. A. (1961). Aggregation of variables in dynamic
	systems. \emph{Econometrica, 29}(2), 111--138.
https://doi.org/10.2307/1909285

Cover, T. M., \& Thomas, J. A. (2006). \emph{Elements of information
	theory} (2nd ed.). Wiley. https://doi.org/10.1002/047174882X
...
Kemeny, J. G., \& Snell, J. L. (1960). \emph{Finite Markov chains}.
	Van Nostrand. Reprinted 1976, Springer.
