...
require perfect closure everywhere. The mathematical study of approximate aggregation has a long history, particularly in the analysis of nearly decomposable systems (Simon \& Ando, 1961). The present extension is philosophical rather than technical: it uses graded closure to support graded ontological verdicts, not to improve estimation.
...
Simon, H. A., \& Ando, A. (1961). Aggregation of variables in dynamic
